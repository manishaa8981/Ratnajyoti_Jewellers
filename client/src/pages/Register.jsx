      ...
      <div className="h-[92.30vh] flex">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50">
          <div className="w-full max-w-md">
            <h1 className="text-3xl font-bold text-gray-900 mb-8 text-center">Signup</h1>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <input id="name" name="name" type="text" value={formData.name} onChange={handleChange}
                  ...
                  className="w-full px-4 py-3 border border-bronze rounded-lg text-gray-900 placeholder-gray-500" required />
              </div>
